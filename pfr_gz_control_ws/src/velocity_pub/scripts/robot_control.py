...
class Joy_subscriber(Node):
    ...
    def listener_callback(self, data):
        ...
        if(data.buttons[0] == 1):   # in-phase 
            mode_selection = 2
        elif(data.buttons[1] == 1): # opposite phase 
            mode_selection = 1
        elif(data.buttons[2] == 1): # pivot turn
            mode_selection = 3
        else:
            mode_selection = 4
        ...
        vel_msg.angular.z = data.axes[2]*2
